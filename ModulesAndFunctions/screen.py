...
radio_2 = tkinter.Radiobutton(option_frame, text="Timestamp", value=2, variable=rb_value)
radio_3 = tkinter.Radiobutton(option_frame, text="Path", value=3, variable=rb_value)
...
month_spin = tkinter.Spinbox(date_frame, width=5, values=('jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep',
                                              'oct', 'nov', 'dec'))
year_spin = tkinter.Spinbox(date_frame, width=5, from_=2000, to=2999)
...
# map buttons
ok_button.grid(row=4, column=3, sticky='w')
