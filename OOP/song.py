...
class Artist:
    ...
    def add_song(self, name, year, title):
        """
        add a new song to an album in the collection and adds a new album
        if it does not exist.

        :param name: (str): Name of the album
        :param year: (int): The year the album was produced
...
def find_object(field, object_list):
    """ Check 'object_list' to see if an object with 'name' attribute equal  to 'field' exists,
    if so, return it.
    :param field: name to check
    :param object_list: list of object currently initialized
    :return: field object
    """
...
def load_data():
    ...
    with open("Resources/albums.txt", "r") as albums:
        for line in albums:
